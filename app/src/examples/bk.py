...
def graficar_datos(datos):
    ...
    ax.set_ylabel('Numero de muestra')
    ax.set_title('Gráfico de Polígonos')
...
datos_excel = leer_datos_excel('../../resources/data/dataTest.csv')

class ChartWidget(QWidget):
    def __init__(self):
        super().__init__()
        
        datos_excel = leer_datos_excel('../../resources/data/data.csv')
